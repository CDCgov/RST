...
#'
#' @noRd
get_priors = function(priors, num_region, num_group, num_time, .ignore_checks) {
  ...
  if (!.ignore_checks) {
    check_priors(priors, num_region, num_group, num_time)
  }
  if (!is.null(primiss)) {
...
#'
#' @noRd
check_priors = function(priors, num_region, num_group, num_time) {
  cat("Checking priors...\n")
